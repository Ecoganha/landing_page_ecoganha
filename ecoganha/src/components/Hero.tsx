...
export const Hero = () => {
    return (
        <div className="text-center flex flex-col justify-center mt-9 mb-4 max-w-[1280px] md:mx-auto md:flex-row">
            <img className="mx-auto md:order-2 md:pt-20 md:flex-1 md:mr-10" src=".\src\assets\img_hero.png" alt="imagem de funções no celular" />
            <div className="md:order-1 md:flex md:flex-col md:justify-center md:flex-2 md:items-start md:text-left md:max-w-[900px] md:ml-10">
                ...
                <p className="mx-11 my-4 text-xl text-[#003F25] md:mx-0 md:my-6">O Ecoganha transforma o descarte correto de recicláveis em benefícios reais. Recicle, acumule pontos e troque por produtos sustentáveis!</p>
                <div>
                    <Btn />
                </div>
            </div>
